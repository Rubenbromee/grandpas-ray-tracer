...
struct camera {
	...
	double vertical_field_of_view = 120.0; // Vertical view angle (field of view)
...
color ray_color(const ray& ray, int depth, const std::vector<scene_object>& scene_objects, const std::vector<scene_object>& shadow_objects, const std::vector<scene_object>& lights, const camera& camera);
